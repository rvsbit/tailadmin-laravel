    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-8 shadow dark:border-gray-800 dark:bg-gray-900">
                <h1 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Edit commision rate</h1>
                <p class="mb-8 text-gray-600 dark:text-gray-400">Update commision rate information</p>
                ...
                <form method="POST" action="{{ route('commision.update', $rates['id']) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" id="level" name="level" placeholder="e.g., L1, L2, L3"
                            value="{{ old('level', $rates['level'] ?? '') }}" required
